...
export var NewClock = function (__exports) {
  ...
  var view = __exports.view = function (kinds, model, dispatchLocal, dispatchServer) {
    return createElement("div", {}, createElement("h4", {}, "Create new clock"), view_1(null, "", model.name, function ($var220) {
      ...
      var activePatternResult1276_1 = _Parsed___(model.name);

      if (activePatternResult1276_1 != null) {
        var create_1 = new CreateClock(model.selectedKind, activePatternResult1276_1);
...
export var initCommands = ofArray([new Command("Classes", []), new Command("State", [])]);
